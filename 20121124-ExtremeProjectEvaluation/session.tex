...
\begin{document}
	...
	\begin{frame}{Esplorazione: Brainstorming}		
		\begin{columns}[T]
		    ...
		    \end{column}
		    \begin{column}{.5\textwidth}
				\hspace*{-0.4cm} \includegraphics[scale=0.18]{images/mindmap.png}
		    \end{column}
		 \end{columns}
	\end{frame}
	...
	\begin{frame}{Esplorazione: Cosa?}
	    ...
	    \begin{column}{0.4\textwidth}
			\hspace*{-0.9cm} \includegraphics[scale=0.115]{images/stories.png}
			\\ \vspace*{0.4cm}
			\hspace*{-0.9cm} \includegraphics[scale=0.11]{images/domain.png}
	    \end{column}
	 \end{columns}
	\end{frame}
	...
	\begin{frame}{Esplorazione: Come?}
	    ...
	    \end{column}
	    \begin{column}{.5\textwidth}
			\hspace*{-0.6cm} \includegraphics[scale=0.3]{images/architecture.png}
	    \end{column}
	 \end{columns}
	...
	\begin{frame}{Sì, ma...}
		...
		\end{itemize}
		\begin{center}
			\hspace*{-0.3cm} \includegraphics[scale=0.21]{images/takeaway.png}
		\end{center}
	\end{frame}

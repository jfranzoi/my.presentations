...
\begin{document}
	...
	\begin{frame}{Ok, ma...}
		...
		\speakernote{ alla fine però bisogna \textbf{decidere} se partire. valutazione da entrambe le parti. fornitore valuta rischio rispetto a condizioni economiche. valuta anche rischi dovuti a grado di collaborazione, accesso informazioni e libertà operativa sugli ambienti offerta. (es: buon margine economico, ma accesso in collaudo rigido e poco frequente) }
		\speakernote{ parte difficile: il contratto. \textbf{non solo sintesi} di effort, elasped e costi, ma garantire rilasci incrementali con accettazione formale. proposta: vantaggioso per entrambe le parti }

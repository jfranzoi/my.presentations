...
\begin{document}
	...
	\begin{frame}{Esplorazione: Cosa?}
		...
		\speakernote{ ora inizia \textbf{analisi}: in XP con user stories. cartoncini scritti a mano, nome, note, domande. granularità grossa (temi), es: aree website, servizi offerti. }

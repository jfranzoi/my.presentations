...
\begin{document}
	...
	\begin{frame}{Esplorazione: Come?}
		...
		\begin{itemize}
			...
			\note[item]{ Spikes per aree che non si conoscono, come integrazione con sistemi esterni. Codice scritto per dimostrare la fattibilità tecnica. Poi si versiona per consultazione, ma di fatto si butta via}
		\end{itemize}
	...
	\begin{frame}{Per Approfondire}
		...
		\note[item]{ Contratti: ho riportato sul blog personale alcuni link, (dopo una domanda allo scorso IAD). Es: un articolo di Peter Stevens che ha ispirato una presentazione del Milano XPUG}
	\end{frame}
		...
		\begin{itemize}
			\item \textbf{Contatti}
				\begin{itemize}
					...
					\item \highlight{ \href{http://www.linkedin.com/in/jacopofranzoi}{http://www.linkedin.com/in/jacopofranzoi}}
				\end{itemize}
		\end{itemize}

		\begin{itemize}
			\item \textbf{Cosa faccio}
				\begin{itemize}

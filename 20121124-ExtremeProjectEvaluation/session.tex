...
\begin{document}
	...
	\begin{frame}{Reporting: Non un \emph{contratto}!}
		...
		\speakernote{ presentazione: chi scrive (team), date incontri con il cliente. report valutazione: narrativa del progetto, usando i concetti di DOMINIO condivisi. modello del dominio come riassunto }
		\speakernote{ narrativa dei RILASCI: scope, obiettivi. per ogni rilascio, elenco TEMI, con note e domande aperte. (eventuale spiegazione come si stima). composizione team. tabelle riassuntive EFFORT ed ELAPSED }
		\speakernote{ soluzione tecnica: archittura logica, integrazione sistemi esistenti. vincoli di hosting }
		\speakernote{ costi: hosting e servizi a supporto dell'esercizio }

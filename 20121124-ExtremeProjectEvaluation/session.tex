...
\begin{document}
	...
	\begin{frame}{Commitment: Stima}
		...
		\speakernote{ abbiamo capito i desiderata del cliente e abbiamo una supposizione per come realizzarli. ora dobbiamo capire se sia sostenibile: stima dei temi/storie. \textbf{supposizione}, non promessa }
		\speakernote{ dobbiamo gestire \textbf{incertezza}: 1) unità di misura a granularità grossa, settimane/coppia (pair programming) 2) due livelli di confidenza, probabilità di riuscire: 50\% (minima, tutto va liscio e abbiamo esperienza pregressa), 90\% (massima, emergono complessità) }

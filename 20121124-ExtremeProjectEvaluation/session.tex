...
\begin{document}
	...
	\begin{frame}{Esplorazione: Brainstorming}
		...
		\speakernote{ note, dubbi e domande. dominio, fasi e scadenze. \textbf{non in dettaglio}, bisogna quindi saper interrompere e rimandare }
	...
	\begin{frame}{Esplorazione: Cosa?}
		...
		\speakernote{ indipendenti: \ticks{in che ordine?}, negoziabili: \ticks{facciamo o no?}. \textbf{nessuna stima} perchè esplorazione, non commitment. }
		\speakernote{ concetti del dominio, relazioni, cardinalità. obiettivo: \textbf{linguaggio} comune, comprensione, comunicazione. concetti: identità. relazioni: associazione, appartenenza, catalogo. cardinalità: 0..1, 1, molti}
	...
	\begin{frame}{Esplorazione: Come?}
		...
		\speakernote{ \textbf{design} di sistema: in XP architettura evolve con lo sviluppo. individuare rischi: sistemi esterni, tecnologie, asincronicità. delle tante \ticks{viste} con cui descrivere architettura, sceglamo quella \ticks{logica}, componenti e connettori, ad alto livello: quali sistemi, come parlano, come accedono gli utenti. }
	...
	\begin{frame}{Commitment: Piano di Rilascio}
		...
		\begin{columns}[T]
		    ...
		    \begin{column}{.45\textwidth}
				...
				\\ \vspace*{0.2cm}
				\hspace*{-0.5cm} \includegraphics[scale=0.34]{images/elapsed}
		    \end{column}
		\end{columns}
	...
	\begin{frame}{Commitment: Costi}
		...
		\speakernote{ può essere utile dare un'indicazione dei costi di hosting, come previsione per ambienti di produzione e staging. ad esempio usando il calcolatore on-line offerto dai servizi di cloud computing. è la parte \textbf{meno sotto controllo}, dipenderà da architettura e dimensionamento ambienti }
		\speakernote{ anche servizi per l'esercizio e il monitoraggio, ma \textbf{non indispensabili} }
	...
	\begin{frame}{Reporting: Non un \emph{contratto}!}
		...
		\speakernote{ \textbf{riassunto} di quanto raccolto. per clienti: un documento, internamente: pagina sulla wiki }
		\speakernote{ una \textbf{traccia}. presentazione: chi scrive (team), date incontri con il cliente. report valutazione: narrativa del progetto, usando i concetti di dominio condivisi. modello del dominio come riassunto. narrativa dei rilasci: scope, obiettivi. per ogni rilascio, elenco temi, con note e domande aperte. (eventuale spiegazione come si stima). composizione team. tabelle riassuntive effort ed elapsed. soluzione tecnica: architettura logica, integrazione sistemi esistenti. vincoli di hosting. costi: hosting e servizi a supporto dell'esercizio }
	...
	\begin{frame}{Sì, ma...}
		...
		\speakernote{ questa valutazione è un \textbf{investimento}, deve esserci una copertura economica. fornitore, se preventivo per cliente potenziale. cliente, formula del kick-start di 2-5 giorni }
	\end{frame}
	...
	\begin{frame}{Ok, ma...}
		...
		\speakernote{ parte difficile: il contratto. \textbf{non solo sintesi} di effort, elasped e costi, ma garantire rilasci incrementali con accettazione formale. vantaggioso per entrambe le parti: diverse proposte (vedi dopo) }
	...
	\begin{frame}{Cosa Portare a Casa}
		...
		\speakernote{ una \textbf{strategia} per pianificare progetti software: esplorazione, commitment e steering. quali valori vi stanno dietro. (di fatto, un'introduzione ad XP) }
		...
		\speakernote{ tecniche per \textbf{gestire} incertezza e rischio nelle stime effort, così da ottenere un elapsed che porti ad un piano operativo }
	...
	\begin{frame}{Per Approfondire}
		...
		\speakernote{ per approfondire, il libro bianco resta il libro di \textbf{riferimento} da cui partire. valori, principi e pratiche. descrizione precisa dei ruoli e delle regole del \ticks{gioco della pianificazione} }
		...
		\speakernote{ la prospettiva e la \textbf{notazione} per l'architettura logica dei sistemi è presa da Pryce, che le usa nelle sue presentazioni. per il concetto di \ticks{viste} consiglio \ticks{\emph{Documenting Software Architectures: Views and Beyond - 2nd ed}} di Clemens }
